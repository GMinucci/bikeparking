    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('open', 'Aberto'), ('confirmed', 'Confirmado'), ('refused', 'Cancelado')], default='open', max_length=50)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_time', models.DateField(blank=True, verbose_name='Data de inicio')),
